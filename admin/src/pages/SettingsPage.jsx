          ...
          {[
            ...
            <div key={p.key} className="flex items-center justify-between border border-gray-100 rounded-xl px-4 py-3.5">
              ...
              <button
                ...
                className={`w-11 h-6 rounded-full transition-colors relative flex-shrink-0 ${payment[p.key] ? "bg-red-600" : "bg-gray-200"}`}
              >
                <span
